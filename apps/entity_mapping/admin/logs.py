...
class SyncLogAdmin(admin.ModelAdmin):
    ...
    list_filter = ["action", "status", "created_by", "created"]
    ...
    def entity_mapping_link(self, obj):
        ...
        if obj.entity_mapping:
            url = reverse("admin:entity_mapping_entitymapping_change", args=[obj.entity_mapping.id])
            return format_html(
                '<a href="{}">{}</a>',
                url,
    ...
    def status_display(self, obj):
        ...
        colors = {"success": "#28a745", "error": "#dc3545", "warning": "#ffc107"}
