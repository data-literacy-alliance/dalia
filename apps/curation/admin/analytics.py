...
class ViewEventAdmin(BaseModelAdmin):
    list_display = ("user_display", "content_object_display", "created", "duration_seconds", "ip_address")
    list_filter = ("content_type", "created", "user")
    search_fields = ("user__username", "ip_address", "session_id")
    readonly_fields = (
        "created", "modified", "user", "content_type", "object_id",
        "session_id", "ip_address", "user_agent", "referrer", "duration_seconds",
    )
...
class EditLogAdmin(BaseModelAdmin):
    ...
    readonly_fields = (
        "uuid", "created", "modified", "user", "content_type", "object_id",
