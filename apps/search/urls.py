...
urlpatterns = [
    # Search filters
    path('v1/basic-search-filters/', views.BasicSearchFiltersView.as_view(), name='basic_search_filters'),
    ...
    # Community endpoints
    path('v1/communities/<uuid:community_id>/', views.CommunityView.as_view(), name='community_detail'),
    path('v1/communities/<uuid:community_id>/items/', views.CommunityItemsView.as_view(), name='community_items'),
]
