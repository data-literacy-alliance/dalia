...
def _map_media_type_uris_to_label_value_items(
...
def get_media_types_for_resources(
    resource_uri_refs: List[URIRef],
) -> Dict[URIRef, List[LabelValueItem]]:
    """
    Retrieve the media types for each of the given learning resource URIRefs.
    ...
    return get_one_to_many_metadata_for_resources(
        ...
        items_mapping_fn=_map_media_type_uris_to_label_value_items,
    )
