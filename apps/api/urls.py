...
router.register(
    "curation/learning-resource-types", LearningResourceTypeViewSet, basename="curation-lrtypes"
)
...
router.register(
    "curation/proficiency-levels", ProficiencyLevelViewSet, basename="curation-proficiency"
)
...
router.register(
    "curation/resource-contents", ResourceContentViewSet, basename="curation-resourcecontents"
)
...
router.register(
    "curation/review-questions", ReviewQuestionViewSet, basename="curation-reviewquestions"
)

# Legal compliance
router.register("curation/consents", ResourceConsentViewSet, basename="curation-consents")
router.register(
    "curation/publishing-consents",
    ResourcePublishingConsentViewSet,
    basename="curation-publishingconsents",
)

# Relation types
router.register(
    "curation/relation-type-categories",
    RelationTypeCategoryViewSet,
    basename="curation-relationtypecategories",
)
...
router.register(
    "curation/community-relations",
    ResourceCommunityRelationViewSet,
    basename="curation-communityrelations",
)
router.register(
    "curation/related-items", ResourceRelatedItemViewSet, basename="curation-relateditems"
)

# Account deletion (GDPR)
router.register(
    "account/deletion-requests", AccountDeletionRequestViewSet, basename="account-deletion-requests"
)
router.register(
    "account/deletion-items", AccountDeletionItemViewSet, basename="account-deletion-items"
)
router.register(
    "account/deletion-logs", AccountDeletionLogViewSet, basename="account-deletion-logs"
)
...
urlpatterns = [
    ...
    path(
        ...
        CurationSuggestCommunitiesView.as_view(),
        name="suggest-communities",
    ),
    path(
        "v1/curation/suggest/learning-resource-types/",
        CurationSuggestLearningResourceTypesView.as_view(),
        name="suggest-lrtypes",
    ),
    path(
        "v1/curation/suggest/languages/",
        CurationSuggestLanguagesView.as_view(),
        name="suggest-languages",
    ),
    path(
        "v1/curation/suggest/disciplines/",
        CurationSuggestDisciplinesView.as_view(),
        name="suggest-disciplines",
    ),
    path(
        "v1/curation/suggest/licenses/",
        CurationSuggestLicensesView.as_view(),
        name="suggest-licenses",
    ),
    path(
        "v1/curation/suggest/proficiency-levels/",
        CurationSuggestProficiencyLevelsView.as_view(),
        name="suggest-proficiency",
    ),
    path(
        "v1/curation/suggest/target-groups/",
        CurationSuggestTargetGroupsView.as_view(),
        name="suggest-targetgroups",
    ),
    path(
        "v1/curation/suggest/media-types/",
        CurationSuggestMediaTypesView.as_view(),
        name="suggest-mediatypes",
    ),
    path(
        "v1/curation/suggest/relation-types/",
        CurationSuggestRelationTypesView.as_view(),
        name="suggest-relationtypes",
    ),
    # Ping test route
