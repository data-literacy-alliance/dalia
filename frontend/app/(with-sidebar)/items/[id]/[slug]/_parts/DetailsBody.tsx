        ...
        <div className={'flex flex-col lg:flex-row'}>
          ...
          >
            ...
            >
              ...
              >
                {item.description ? (
                  <ReactMarkdown>{normalizeDescriptionText(item.description)}</ReactMarkdown>
                ) : (
                  <i>No description</i>
                )}
              </div>
                    ...
                    <ul className={'ml-4 list-inside list-disc'}>
                      {item.disciplines.map((discipline) => (
                        <li key={discipline.value}>
                          <Link
                            href={`/search?${new URLSearchParams([['query', '*'], ['offset', '0'], ['source', 'basic'], ['http://purl.org/spar/fabio/Discipline', discipline.value]])}`}
                  ...
                  <Text className={'block'}>
                    ...
                    <ul className={'ml-4 list-inside list-disc'}>
                      {item.target_groups.map((targetGroup) => (
                        <li key={targetGroup.value}>
                          <Link
                            href={`/search?${new URLSearchParams([['query', '*'], ['offset', '0'], ['source', 'basic'], ['https://purl.org/ontology/modalia#TargetGroup', targetGroup.value]])}`}
                    ...
                    <Text className={'block'}>
                      ...
                      <ul className={'ml-4 list-inside list-disc'}>
                        {item.proficiency_levels.map((proficiencyLevel) => (
                          <li key={proficiencyLevel.value}>
                            <Link
                              href={`/search?${new URLSearchParams([['query', '*'], ['offset', '0'], ['source', 'basic'], ['https://purl.org/ontology/modalia#Proficiency', proficiencyLevel.value]])}`}
