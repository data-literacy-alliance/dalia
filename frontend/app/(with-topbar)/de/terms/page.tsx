...
export default async function TermsDePage() {
  const content = (await fetchPageContent('terms', 'de'))
    ?? '_Deutsche Version noch nicht verfügbar. Bitte lesen Sie die [englische Version](/en/terms)._';

  return (
    <div className={'mx-auto w-full max-w-screen-lg text-left'}>
      <div className={'flex gap-2 mb-5'}>
        <Button small link={{ href: '/en/terms' }}>
          English
        </Button>
