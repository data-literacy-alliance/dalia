...
export default async function PrivacyPolicyDePage() {
  const content = (await fetchPageContent('privacy-policy', 'de'))
    ?? '_Datenschutzhinweise werden geladen..._';

  return (
    <div className={'mx-auto w-full max-w-screen-lg text-left'}>
      <div className={'flex gap-2 mb-5'}>
        <Button small link={{ href: '/en/privacy-policy' }}>
          English
        </Button>
