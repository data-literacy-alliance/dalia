...
export default async function AccessibilityDePage() {
  const content = (await fetchPageContent('accessibility', 'de'))
    ?? '_Deutsche Version noch nicht verfügbar. Bitte lesen Sie die [englische Version](/en/accessibility)._';

  return (
    <div className={'mx-auto w-full max-w-screen-lg text-left'}>
      <div className={'flex gap-2 mb-5'}>
        <Button small link={{ href: '/en/accessibility' }}>
          English
        </Button>
