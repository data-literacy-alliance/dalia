...
export default async function AccessibilityEnPage() {
  const content = (await fetchPageContent('accessibility', 'en'))
    ?? '_English version not yet available. Please refer to the [German version](/de/accessibility)._';
  ...
  return (
    <div className={'mx-auto w-full max-w-screen-lg text-left'}>
      <div className={'flex gap-2 mb-5'}>
        ...
        <Button small link={{ href: '/de/accessibility' }}>
          German
        </Button>
      </div>
